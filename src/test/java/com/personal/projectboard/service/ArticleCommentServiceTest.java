...
class ArticleCommentServiceTest {
    ...
    void givenArticleCommentInfo_whenSavingComment_thenSaveComment(){
        ...
        ArticleCommentDto dto = ArticleCommentDto.of(
                LocalDateTime.now(), "kim", LocalDateTime.now(), "Lee", "content"
        );

        given(articleCommentRepository.save(any(ArticleComment.class))).willReturn(null);

        // When
        sut.saveArticleComments(dto);
    ...
    void givenModifiedInfo_whenUpdatingComment_thenUpdateComment(){
        ...
        // When
        sut.updateArticleComment(1L, ArticleCommentUpdateDto.of(LocalDateTime.now(), "Lee", "LGTM"));
